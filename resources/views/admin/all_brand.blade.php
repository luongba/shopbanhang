      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{ route('brand.show',[$value->brand_id]) }}" class="active" ui-toggle-class=""><input type="submit" class="btn btn-warning" value="Edit"></a></a>
              
            </td>
            <td>
                              <form action="{{ route('brand.destroy',[$value->brand_id]) }}" method="POST">
                                  @csrf
                                  @method('delete')
