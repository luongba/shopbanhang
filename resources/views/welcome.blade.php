                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                <li><a href="{{ route('check.login') }}"><i class="fa fa-user"></i> Tài Khoản</a></li>
                                <li><a href="#"><i class="fa fa-star"></i> Yêu Thích</a></li>
                                <li><a href="{{ route('cart.index') }}"><i class="fa fa-crosshairs"></i> Thanh Toán</a></li>
                                <li><a href="cart.html"><i class="fa fa-shopping-cart"></i> Giỏ Hàng</a></li>
                                <li><a href="{{ route('check.login') }}"><i class="fa fa-lock"></i> Đăng Nhập</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{ route('category.show',[$cate->category_id]) }}">{{$cate->category_name}}</a></h4>
                                </div>
                            </div>
                            @endforeach
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="{{ route('brand.show',[$br->brand_id]) }}"> <span class="pull-right">(50)</span>{{$br->brand_name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div><!--/brands_products-->
